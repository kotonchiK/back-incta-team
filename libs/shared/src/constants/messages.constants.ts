export const Messages = {
  ...
  SUCCESS_USER_DELETED: 'The user has been successfully deleted',
  SUCCESS_USERS_RETRIEVED: 'Users have been successfully retrieved.',
  ...
  ERROR_RETRIEVING_USERS: 'An error occurred while retrieving users.',
  ...
  DESC_DELETE_USER: 'Delete a user by ID',
  DESC_USER_ID: 'The ID of the user',
  DESC_GET_USERS: 'Retrieve a list of all users or a single user by ID',
  DESC_USER_LIST: 'List of user objects',
  DESC_SINGLE_USER: 'Single user object',
  ...
  DESC_USER_ID_PARAM: 'The unique identifier of the user (optional)',
  DESC_USER_ID_SAMPLE: 'c3442bd7-8195-4730-8506-1a405e3cad1a',
};
